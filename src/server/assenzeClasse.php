<?php
    ...
    $query = "SELECT id, data, giustificato, assenze.matricola FROM assenze, studenti WHERE classe = '$classe' AND assenze.matricola = studenti.matricola ORDER BY data DESC";
